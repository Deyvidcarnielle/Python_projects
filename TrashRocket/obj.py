...
class Obj:
    ...
    def anim(self, image, tick, frames):
        ...
        self.sprite.image = pygame.image.load("assets_TR/" + image + str(self.frame) +".png")
...
class Trash(Obj):
    ...
    def __init__(self, image, x, y):
        ...
        pygame.mixer.init()
        self.sound_pts = pygame.mixer.Sound("assets_TR/engr_sound.ogg")
        self.sound_block = pygame.mixer.Sound("assets_TR/bateu.ogg")

        self.life = 3
        self.pts = 0

    def move_trash(self, event):
        if event.type == pygame.MOUSEMOTION:
            self.sprite.rect[0] = pygame.mouse.get_pos()[0] - 27.5
            self.sprite.rect[1] = pygame.mouse.get_pos()[1] - 47.5
    ...
    def colision(self, group, name):
        ...
        if name == "engr" and colision:
            self.pts += 1
            self.sound_pts.play()
        elif name == "pomba" and colision:
            self.life -= 1
